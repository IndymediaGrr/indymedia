...
### ------------------------------------------------------
### - Date : 14-Jun-2012 09:03:17
### - Fichier d'origine : ../plugins/auto/indymedia/v0.1/plugin.xml
...
# svn add lang/paquet-indymedia_fr.php
...
# svn mv base/indymedia_installation.php indymedia_administrations.php
